...
const typingTexts = [
  ...
  "Sustainable Bamboo Creations for Everyday Life",
      ...
      <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-xl shadow-lg">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight min-h-[100px] md:min-h-[140px]">
              {displayedText}
              <motion.span
                animate={{ opacity: [1, 0] }}
