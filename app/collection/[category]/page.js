...
const ALL_PRODUCTS = [
  {
    ...
    oldPrice: "$110.00",
    rating: 4.8,
    image: "/images/bamboo-craft-46.jpg",
  ...
  },
  {
    ...
    oldPrice: "$45.00",
    rating: 4.9,
    image: "/images/bamboo-craft-02.jpg",
  ...
  },
  {
    ...
    oldPrice: "$55.00",
    rating: 4.7,
    image: "/images/bamboo-craft-23.jpg",
    category: "home-decor",
  },
  {
    id: 4,
    ...
    oldPrice: "$35.00",
    rating: 5.0,
    image: "/images/bamboo-craft-04.jpg",
    category: "kitchen-dining",
  },
  {
    id: 5,
    name: "Premium Bamboo Chair",
    price: "$120.00",
    rating: 5.0,
    image: "/images/bamboo-craft-05.jpg",
    category: "home-decor",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    price: "$18.00",
    rating: 4.9,
    image: "/images/bamboo-craft-07.jpg",
    category: "kitchen-dining",
  },
  {
    id: 8,
    ...
    price: "$65.00",
    rating: 4.6,
    image: "/images/bamboo-craft-08.jpg",
    category: "home-decor",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    oldPrice: "$120.00",
    rating: 4.9,
    image: "/images/bamboo-craft-20.jpg",
    category: "lamps-lighting",
  },
  {
    id: 12,
    ...
    price: "$38.00",
    rating: 4.8,
    image: "/images/bamboo-craft-34.jpg",
    category: "kitchen-dining",
  },
];
    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-32 min-h-screen">
      ...
      >
        ...
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">
          Explore our premium selection of sustainable bamboo products, designed
          to bring nature's elegance into your everyday life.
        </p>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="space-y-2 flex-grow flex flex-col">
                ...
                <h3 className="font-extrabold text-[#2D2D2D] line-clamp-1 text-lg group-hover:text-[#1A4314] transition-colors duration-300">
                  {product.name}
                </h3>

                <div className="flex items-center gap-3 mt-auto pt-3">
                  <span className="text-xl font-black text-[#1A4314]">
                    {product.price}
                  </span>
                  {product.oldPrice && (
