...
const ALL_PRODUCTS = [
  { id: 1, name: "Bamboo Pendant Light", price: "$85.00", oldPrice: "$110.00", rating: 4.8, image: "/images/bamboo-craft-01.jpg", category: "lamps-lighting" },
  { id: 2, name: "Woven Fruit Basket", price: "$32.00", oldPrice: "$45.00", rating: 4.9, image: "/images/bamboo-craft-02.jpg", category: "kitchen-dining" },
  { id: 3, name: "Minimalist Planter", price: "$45.00", oldPrice: "$55.00", rating: 4.7, image: "/images/bamboo-craft-03.jpg", category: "home-decor" },
  { id: 4, name: "Dining Mat Set", price: "$28.00", oldPrice: "$35.00", rating: 5.0, image: "/images/bamboo-craft-04.jpg", category: "kitchen-dining" },
  { id: 5, name: "Premium Bamboo Chair", price: "$120.00", rating: 5.0, image: "/images/bamboo-craft-05.jpg", category: "home-decor" },
  { id: 6, name: "Bamboo Storage Box", price: "$45.00", rating: 4.8, image: "/images/bamboo-craft-06.jpg", category: "home-decor" },
  { id: 7, name: "Eco-friendly Cutlery", price: "$18.00", rating: 4.9, image: "/images/bamboo-craft-07.jpg", category: "kitchen-dining" },
  { id: 8, name: "Handcrafted Vase", price: "$65.00", rating: 4.6, image: "/images/bamboo-craft-08.jpg", category: "home-decor" },
  { id: 9, name: "Bamboo Desk Lamp", price: "$55.00", rating: 4.9, image: "/images/bamboo-craft-09.jpg", category: "lamps-lighting" },
  { id: 10, name: "Wall Art Decor", price: "$40.00", rating: 4.5, image: "/images/bamboo-craft-10.jpg", category: "home-decor" },
  { id: 11, name: "Woven Lampshade", price: "$95.00", oldPrice: "$120.00", rating: 4.9, image: "/images/bamboo-craft-11.jpg", category: "lamps-lighting" },
  { id: 12, name: "Bamboo Serving Tray", price: "$38.00", rating: 4.8, image: "/images/bamboo-craft-12.jpg", category: "kitchen-dining" },
];
